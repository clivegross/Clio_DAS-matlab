...
function [datacell dtstr] = get_TDasxann

% retrieve html source code from website
urlcode = urlread('http://www.asx.com.au/asx/statistics/todayAnns.do');
...
nt1 = strfind(urlcode,'<title>'); %index beginning
nt2 = strfind(urlcode,'</title>'); %index end
dtstr = urlcode(nt1(2)+45:nt2(2)-1)
